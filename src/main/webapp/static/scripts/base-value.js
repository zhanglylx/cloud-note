...
// var path_edit = path + "/edit.html";
// var path_edit_books = path + "/book/loadBooks.do";
// var path_edit_note = path + "/note/loadnotes.do";
// var path_edit_note_load = path + "/note/load.do";
// var path_edit_note_update = path + "/note/update.do";
// var path_edit_note_add = path + "/note/add.do";
const path_login_page = "/log-in.html";
const path_login = "user/login.do";
const path_login_add = "user/add.do";
const path_edit = "edit.html";
const path_edit_books = "book/loadBooks.do";
const path_edit_books_add = "book/add.do";
const path_edit_note = "note/loadnotes.do";
const path_edit_note_load = "note/load.do";
